...
static BuiltinId builtin_id(const char *name) {
    ...
    if (strcmp(name, "str_split_str") == 0 || strcmp(name, "str_split") == 0) return BI_STR_SPLIT_STR;
    if (strcmp(name, "str_join_arr") == 0 || strcmp(name, "str_join") == 0) return BI_STR_JOIN_ARR;
